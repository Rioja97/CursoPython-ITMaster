...
print(f"{billetes_mil} billetes de 1000")
print(f"{billetes_doscientos} billetes de 200")
print(f"{billetes_cien} billetes de 100")
print(f"{billetes_cincuenta} billetes de 50")
